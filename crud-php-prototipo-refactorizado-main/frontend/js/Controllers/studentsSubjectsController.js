...
document.addEventListener('DOMContentLoaded', () => 
{
    initSelects();
    /**
     * Carga las opciones de los selects de estudiantes y materias al cargar la página.
     */
    setupFormHandler();
    /**
     * Configura el manejador del formulario de relaciones.
     */
    loadRelations();
    /**
     * Carga la tabla de relaciones al cargar la página.
     */
});
...
function setupFormHandler() 
{
    ...
    form.addEventListener('submit', async e => 
    {
        ...
        {
            /**
             * Si en el submit hay un id, entonces hay que actualizar la relación, sino crearla.
             */
            if (relation.id) 
            {
